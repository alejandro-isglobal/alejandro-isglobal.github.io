...
Si bien la estadística llega a desarrollar elementos con un alto grado de abstracción y una teoría para su manipulación, ella es una ciencia de interés primordialemente empírico. Su interés reside en el entendimiento de los datos y por lo tanto en el proceso que resulta de una observación dada. El dato primordial en estadística es numérico, por lo que supone un proceso de medición. Entendemos el proceso de medicion desde una perspectiva general que incluye la comparación numérica de una propiedad de un objeto o evento con respecto a un patrón unidad, o el resultado de su clasificación en un grupo con características determinadas.   
