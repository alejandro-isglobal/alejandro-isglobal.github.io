...
Simulemos la transmisión de una foto de 100 píxeles blancos. Es decir, transmitamos 100 pixels cada uno con una probabilidad de 0.2 de ser transmitido erroneamente. Para esto sólo tenemos que incrementar el número de ensayos de Bernoulli en **sample** 
```{r}
