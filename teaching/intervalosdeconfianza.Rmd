...
Por último, si necesitamos decidir si los experimentos ofrecen evidencia suficiente de que el proceso de producción de altavoces es consistente a un proceso de $4\Omega$, o sea si podemos asumir de que es razonablemente posible que $\mu = 4\Omega$ entonces debemos hacer una prueba de hipótesis.
