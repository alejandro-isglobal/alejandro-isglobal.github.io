...
```{r, echo=FALSE}
par(mfrow=c(1,2))
hist(rnorm(100, 100, 7.5), xlab="outcome", ylab="ni", br=seq(2.5,202.5,5), main="")
lines(c(100, 100), c(0,1000), lty=2, col="red")
points(100,0, pch=2, col="red")

hist(rnorm(100, 100, 20), xlab="outcome", ylab="ni", br=seq(2.5,202.5,5), main="")
lines(c(100, 100), c(0,1000), lty=2, col="red")
points(100,0, pch=2, col="red")
```
...
Debido a que la mediana, el primer y tercer cuertil son medidas robustas, se toma una distancia de 3 rangos cuartíclicos desde la mediana como una región en donde se esperan los datos típicos. Datos que se encruentren fuera de esta región se denominan atípicos. Si retomamos los datos de capacidad de descarga con las baterías defectuosas podemos ver que su capacidad de descarga está fuera de esta región y los podemos denominar atípicos y solemos removerlos de nuestros estudios. 
