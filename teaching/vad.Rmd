...
Imaginemos que tenemos un sistema para transmitir el valor de un pixel con un probabilidad p=0.2 transmitirlo incorrectamente (error:k=1) y 0.8 de ser transmitirlo correctamente (correcto:k=0)  
