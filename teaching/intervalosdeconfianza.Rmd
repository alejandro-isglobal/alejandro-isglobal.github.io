...
Veamos el intervalo de confianza para la varianza. Así como estimamos el parámetro $\mu$ para hubicar dónde se encuentra la distribución para $X$, también estimamos su varianza $\sigma^2_X$ de los datos para determinar la anchura de la distribución de $X$. De hecho, hemos ultizado el valor $s$ para estimar $\sigma_X$ en el cálculo de los intervalos de confianza cuando $\sigma_X$ es desconocido.   
